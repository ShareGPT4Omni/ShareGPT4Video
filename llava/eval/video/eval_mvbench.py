...
from llava.eval.video.mvbench_utils import (MVBenchDataset, check_ans,
...
def load_model_and_dataset(rank, world_size, args):
    ...
    dataset = MVBenchDataset(num_segments=args.num_frames)
...
def parse_args():
    ...
    parser.add_argument("--save_path",
                        type=str,
                        default='./playground/results/mvbench')
