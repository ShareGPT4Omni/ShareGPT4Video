...
export DATA_PATH=data/image_grid/sharegpt4video_sft-mix181k-add-share-28k.json
export SAVE_PATH=llava-v1.6-8b_lama3-8b_video-sft-mix181k-add-share-28k_ft-vit-mlp-llm-lora_lr-vit-2e-6-mlp-2e-5-llm-2e-4_run2
export VIT_LR=2e-6
export BASE_LR=2e-4
export MLP_LR=2e-5
